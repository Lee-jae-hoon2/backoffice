...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height: 912px;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">가맹점 통계</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
pstmt2=conn.prepareStatement("select count(*) from ttowang.business where businessInfo='pizza'");//sql문 너놓고, passwd 주의
