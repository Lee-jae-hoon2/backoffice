...
pstmt=conn.prepareStatement("select * from ttowang.user where userId="+key);//sql문 너놓고, passwd 주의
	...
	%>
                                        ...
                                        <tr><!--  <tr class="odd gradeX"> -->
                                          ...
                                          <input type="hidden" name="key2", value="<%=key%>"></td>
                                            ...
                                            <td>
                                            <button class="btn btn-default" type="submit" OnClick="window.location='MemModify.jsp?key=<%=userId%>'">확인</button>
