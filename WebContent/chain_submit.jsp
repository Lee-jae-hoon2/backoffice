...
pstmt=conn.prepareStatement("select * from ttowang.business");//sql문 너놓고, passwd 주의
...
while(rs.next()){
	...
	%>
                                        ...
                                        <tr><!--  <tr class="odd gradeX"> -->
                                            ...
                                            <td><%=businessMenu %></td>
                                            <td><%=businessBenefit %></td>
                                            <td><%=businessPhoto %></td>
                                            <td><%=businessLat %></td>
                                            <td><%=businessLng %></td>
                                            <td>
                                            <button class="btn btn-default" type="button" OnClick="window.location='Modify.jsp?key=<%=businessId%>'">수정</button>
                                             <button class="btn btn-default" type="submit" OnClick="window.location='Chain_submit_delete.jsp?key=<%=businessId%>'">탈퇴</button>
                                            </td>
                                        </tr><!-- td 넣으면 순서대로 들어간다.-->
                                       <!-- 테이블 반복 -->
	<%
